var game = {
		...
		changing_guesses: "<p style='font-size: 20px'>Guesses left: </p>",

		array_of_words: ["jerry","elaine","costanza","kramer","newman", "seinfeld"],
	...
	document.onkeyup = function(event) {
		...
		if(game.contains(key_up.changing_word," _ ") === false){
			...
			document.querySelector("#victoryImage").innerHTML = "<img class='col-xs-12' src='assets/images/" + chosen_word + ".jpg' + alt=" + chosen_word + ">";
